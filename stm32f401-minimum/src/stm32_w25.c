/****************************************************************************
 * boards/arm/stm32/stm32f401-minimum/src/stm32_w25.c
 *
...
int stm32_w25initialize(int minor)
{
  ...
  const char *partname = CONFIG_STM32F401MINIMUM_FLASH_PART_NAMES;
#endif
  ...
  smart_initialize(CONFIG_STM32F401MINIMUM_FLASH_MINOR, mtd, NULL);
